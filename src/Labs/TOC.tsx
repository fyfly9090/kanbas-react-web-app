...
export default function TOC() {
    ...
    return (
      <ul className="nav nav-pills">
        ...
        <li className="nav-item">
          <a id="wd-github"
               href="https://github.com/fyfly9090/kanbas-react-web-app.git"
               className="nav-link">
            Github            
          </a>
        </li>
        <li className="nav-item">
          <a id="wd-github"
               href="https://github.com/fyfly9090/kanbas-node-server-app.git"
               className="nav-link">
            Github for Node           
          </a>
        </li>
        <li className="nav-item">
          <a id="wd-github"
               href="https://kanbas-node-server-app-0ied.onrender.com"
               className="nav-link">
