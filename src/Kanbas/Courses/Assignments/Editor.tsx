    ...
    return (
      <div id="wd-assignments-editor">
        ...
        <textarea id="wd-description">
          ...
          Link to the Kanbas application Links to all relevant source code repositories The Kanabas application should 
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              <select id="wd-group">
                <option value="QIZZES">QUIZZES</option>
          ...
          <tr>
            ...
            <td>
              <label htmlFor="wd-available-from">Available from&nbsp;&nbsp;&nbsp;&nbsp;Until</label>
            </td>
           </tr>
          <tr>
            <td align="right" valign="top">
          ...
          <tr>
           <td>___________________</td><td>____________________________________</td>
          </tr>
          <tr>
            <td></td>
            <td align= "right">
